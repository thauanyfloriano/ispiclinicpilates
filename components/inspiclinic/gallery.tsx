...
const galleryImages = [
  ...
  { src: "/galeria3.jpeg", alt: "Galeria Inspiclinic 3" },
]
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <AnimatedSection className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-serif text-4xl lg:text-5xl text-[var(--foreground)] mb-6">
            Nossa <span className="text-[var(--gold)]">Estrutura</span>
          </h2>
          <div className="w-16 h-1 bg-[var(--gold)] mx-auto mb-6" />
          <p className="text-[var(--muted-foreground)] text-lg leading-relaxed">
            Descubra nossas instalacoes e o ambiente de excelencia clinica 
            estruturado para o seu maximo bem-estar e recuperacao.
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection animation="fade-up">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[var(--foreground)] to-[#2a2a2a] p-12 lg:p-16 text-center">
            ...
            <div className="absolute top-1/2 left-1/4 w-2 h-2 bg-[var(--gold)] rounded-full animate-ping" />
            <div className="absolute top-1/3 right-1/3 w-1 h-1 bg-[var(--gold)]/50 rounded-full animate-ping" style={{ animationDelay: "0.5s" }} />

            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-6">
                <Sparkles className="w-4 h-4 text-[var(--gold)]" />
                <span className="text-white/80 text-sm">Comece sua transformacao</span>
              </div>

              <h3 className="font-serif text-3xl lg:text-4xl text-white mb-4">
                Pronto para Iniciar sua <span className="text-[var(--gold)]">Recuperacao</span>?
              </h3>
              ...
              <Link
                href="https://wa.me/5511956096075?text=Olá,%20quero%20marcar%20minha%20transformação."
                target="_blank"
